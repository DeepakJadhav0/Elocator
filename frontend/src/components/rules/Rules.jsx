...
import { news, notifications, report } from "./Notification";

const Rules = () => {
  return (
    <div className="flex text-sm pt-24 flex-col section container rules-container">
      <div className="w-full mx-auto  px-4">
        ...
        <h3 className=" font-bold mb-3 text-emerald-600 border-b border-emerald-200 pb-2">CHAPTER I: PRELIMINARY PROVISIONS</h3>
        ...
        <h3 className="font-bold mb-3 text-emerald-600 border-b border-emerald-200 pb-2">CHAPTER II: PRODUCER RESPONSIBILITIES</h3>
      ...
      <div className="flex flex-col md:flex-row w-full mx-auto md:w-full md:max-h-140 max-h-[130rem] gap-10 md:mt-10 px-4">
        ...
        <div className="flex flex-col w-full my-4 h-[600px] shadow-lg bg-gray-50 border border-gray-200 rounded-lg overflow-y-auto p-2">
          <h2 className=" font-bold mb-2 py-2 border-b border-emerald-200 text-center text-emerald-600">
            Official Notifications
          </h2>
          {notifications.map((notification, index) => (
            <div
              key={index}
              className="mb-1 p-4 my-2 border-l-4 border-emerald-100 hover:bg-gray-100 transition duration-300"
            >
        ...
        {/* Industry Updates */}
        <div className="flex flex-col w-full my-4 projects shadow-lg bg-gray-50 border border-gray-200 rounded-lg h-[600px] overflow-y-auto p-2">
          <h2 className="font-bold mb-4 py-2 border-b border-emerald-200 text-center text-emerald-600">
          ...
          {news.map((notification, index) => (
            ...
            >
              ...
              <p className=" mb-3 text-gray-700">{notification.content}</p>
              <a
                href={notification.Link}
                target="_blank"
                rel="noopener noreferrer"
